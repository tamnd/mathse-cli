...
Most of these come down to network reality or how mathse serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

mathse rate-limits like any public site. mathse already paces
...
Where a surface is gated, mathse reads a cookie or token you supply
...
`mathse`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what mathse actually did
